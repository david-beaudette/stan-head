...
class StanUiPlugin(Plugin):
    ...
    def __init__(self, context):
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path('stan_ui'), 'resource', 'stan_ui_widget.ui')
        ...
        self._widget.StartMotorButton.clicked[bool].connect(self._handle_start_motor_button_clicked)
